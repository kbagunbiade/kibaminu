...
const servicesData = [
  {
    ...
    categoryDescription: 'Foundation services for reliable connectivity and network infrastructure',
    services: [
      {
  ...
  },
  {
    ...
    categoryDescription: 'Comprehensive security solutions to protect your business and assets',
    services: [
      {
        icon: '/assets/images/service-designicon.png',
  ...
  {
    category: 'Audio Visual & Smart Systems',
    categoryDescription: 'Modern AV solutions and intelligent automation for enhanced experiences',
    services: [
      {
        icon: '/assets/images/service-producticon.png',
  ...
  },
  {
    ...
    categoryDescription: 'Expert support and management to keep your IT running smoothly',
    services: [
      {
        icon: '/assets/images/service-producticon.png',
  ...
  },
  {
    ...
    categoryDescription: 'Unique solutions for evolving business and technology needs',
    services: [
      {
        icon: '/assets/images/service-producticon.png',
        ...
        <div className="container">
          ...
          <div className="service_contentbox">
            {servicesData.map((category, categoryIndex) => (
              <div key={categoryIndex} className="service-category-section">
                {/* Category Header */}
                <div className="row">
                  <div className="col-12">
                ...
                <div className="row">
                  {category.services.map((service, serviceIndex) => (
                    <div key={serviceIndex} className="col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
